...
var MEEditor = {
  ...
  target: {},
  createElement: function createElement(elements) {
    var _this = this;
    ...
    elements.forEach(function (element) {
      ...
      if (element.attributes) {
        element.attributes.forEach(function (attribute) {
          Object.entries(attribute).forEach(function (_ref) {
      ...
      _this.target[element.name] = node;
      if (element.parentNode) _this.target[element.parentNode].appendChild(node);
      ...
      if (element.children) _this.createElement(element.children);
    });
  },
  ...
  pressedButton: function pressedButton(_ref3, content) {
    ...
    var buttons = [{
      ...
      events: {
        ...
        "function": function _function(event) {
          return _this2.pressedButton(event, _this2.target.editorWrapperContent);
        }
      },
      attributes: [{
  ...
  charCounter: function charCounter(event, editor) {
    var charCounter = event.target.innerHTML.replace(/(<([^>]+)>)/gi, "").length;
  ...
  start: function start(_ref4) {
    var selector = _ref4.selector,
        ...
        height = _ref4.height,
        theme = _ref4.theme,
        defaultSparator = _ref4.defaultSparator;
